...
import com.antique.story.presentation.adapter.StoryListAdapter
import com.antique.story.presentation.adapter.DoorAdapter
...
class StoryFragment : Fragment() {
    ...
    private fun setupRecyclerView() {
        ...
        storyListAdapter = StoryListAdapter {
            val action =
                StoryFragmentDirections.actionStoryFragmentToStoryDetailsFragment(it.storyId)
